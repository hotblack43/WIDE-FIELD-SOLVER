...
|---|---|---|
| Automatic SQLite run storage | Added after the v0.6.0 release | Every go6 analysis appends all available text products and CSV rows, including reruns, saturated/unusable sources, and partial failed runs. No deduplication or quality cut; never read by the solver. See [DATABASE.md](DATABASE.md) |
