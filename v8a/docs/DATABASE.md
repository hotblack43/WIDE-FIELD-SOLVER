...
Run `./go8a.sh /full/path/to/image.jpg` as usual. The launcher automatically passes
...
The lower-level `v8a/analyse.sh` accepts `--database PATH` for explicit callers.
