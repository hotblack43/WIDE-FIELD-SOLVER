...
class BrightnessTests(unittest.TestCase):
    ...
    def test_ceres_and_vesta_use_bundled_horizons_apparent_magnitudes(self):
        self.assertAlmostEqual(planet_brightness('ceres', [2451545.])[0], 8.263,
                               delta=.01)
        self.assertAlmostEqual(planet_brightness('vesta', [2451545.])[0], 7.900,
                               delta=.01)
