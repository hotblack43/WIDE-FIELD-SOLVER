...
\clearpage
\section*{Planets as clock-calendars}
\label{sec:planets}

In images where bright planets are present we have the opportunity to accurately date the exposures. As an example we show in Figure~\ref{fig:planets} an image from Chile by Fred Espenak with Mars, Jupiter and Saturn in. Because there are three planets present it is possible to time the date of the exposure to within 13 minutes.

\begin{center}
  \includegraphics[width=.98\linewidth]{figures/planet_measured_vs_predicted_overlay.png}
  \captionof{figure}{Mars, Jupiter and Saturn accurately time this exposure to just 13 minutes away from photographers stated time of capture (15 April 2018 at 06:55 UTC vs fitted epoch time 2018-04-15 at 07:08:16 UTC).}
  \label{fig:planets}
\end{center}
