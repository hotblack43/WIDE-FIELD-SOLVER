...
Regress instrumental (machine) magnitude minus catalogue magnitude against those
airmasses. Fit zero point and extinction slope as nuisance parameters, then vary
zenith to minimise residual scatter. Incorrect zenith mixes true altitudes and
can produce azimuth-dependent scatter, including on opposite sides of the sky.
...
separate epoch. This is valuable because the stellar proper-motion clock can be
weak. Keep stellar and planetary epoch estimates, their assumptions and their
